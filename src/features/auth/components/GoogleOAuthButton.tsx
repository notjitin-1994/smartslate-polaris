...
export function GoogleOAuthButton() {
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={loading}
      className="w-full inline-flex items-center justify-center gap-2 border border-slate-200 bg-white hover:bg-slate-50 text-slate-900 rounded-xl px-4 py-3 text-sm font-medium transition"
    >
